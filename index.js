   document.getElementById('categorySelect').addEventListener('change', function() {
    ...
    function applyFilter() {
        ...
        let dataByMethod = {
            ...
            "Experimental": [{"name": "Doing It Right, Doing It Wrong: The Effect of Expressive Voting",
                "field": "Political Economy and Public Choice",
                "method": "Experimental",
                "stage": "Work in Progress",
                "url": "",
    ...
    for (let category in data) {
        ...
        data[category].forEach(paper => {
            ...
            console.log("Category:", category);  // to check the current category
